...
def compute_idw_mesh(init_naca, end_naca, ep : int, base_folder : str, path_to_results : str, interp_type = "bezier", density = 100, p = 6, a=1e-15):
    """
    ...
    new_mesh = multistep_idw(original_mesh, mesh_control_points, mesh_displacements, n=10, p=p, a=a)
...
if TEST3:
    ...
    file_idw = f'domain/domain_naca0010_12_4_idw_n={n}.t'
    ...
    new_points = multistep_idw(L, control_points, displ, n, p=4)
