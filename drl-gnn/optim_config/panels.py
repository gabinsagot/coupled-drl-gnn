...
class panels:
    ...
    def __init__(self, path):
        ...
        self.n_panels = 3
        self.x_values = [np.linspace(-30, 30, 13)] * self.n_panels
        self.act_size = [len(val) for val in self.x_values]
    ...
    def convert_actions_continuous(
        self, actions
    ):  # for continuous actions: actions is a set of values in this case
