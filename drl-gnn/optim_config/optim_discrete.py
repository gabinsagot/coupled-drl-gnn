...
class optim_discrete:
    """Optimization configuration for PBO run using discrete action space."""

    def __init__(self, path):
        """
        Initialize the optimization configuration: define environment, GNN, reward, and other parameters.
        Needed essentials by PBO: path, env_name, action_type, x_values, act_size, obs_size, obs,
        ...
        self.x_values = [np.linspace(-30, 30, 13)] * self.n_actions
